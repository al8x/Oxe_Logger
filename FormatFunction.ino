...
void sdError_F(const __FlashStringHelper* str) {
  ...
  if (card.errorCode()) {
    ...
    display.print(int(card.errorCode()));
    display.println(card.errorData());
  }
  while (1);
}
//------------------------------------------------------------------------------
...
void FormatTheCard() {
  if (!card.begin(SD_CS_PIN, SPI_HALF_SPEED)) {
